...
namespace Emojione {
    ...
    public static class Emojione {
        ...
        public static string ToImage(string str, bool ascii = false, bool unicodeAlt = true, bool svg = false, bool sprites = false) {
            ...
            str = ShortnameToImage(str, ascii, unicodeAlt, svg, sprites);
            return str;
        }
        ...
        public static string ShortnameToImage(string str, bool ascii = false, bool unicodeAlt = true, bool svg = false, bool sprites = false) {
            ...
            if (str != null) {
                str = Regex.Replace(str, IGNORE_PATTERN + "|" + SHORTNAME_PATTERN, match => ShortnameToImageCallback(match, unicodeAlt, svg, sprites), RegexOptions.IgnoreCase);
            }
